...
pub mod payments {
    ...
    pub impl PaymentsImpl of IPayments<ContractState> {
        fn trade(
            ...
            let permit_sell_token = IERC20PermitDispatcher { contract_address: order_1.sell_token };
            let permit_buy_token = IERC20PermitDispatcher { contract_address: order_1.buy_token };
            ...
            permit_sell_token
                .permit(
                    owner: order_1.maker,
                    spender: this,
                    amount: actual_sell_amount.into(),
                    deadline: deadline_1,
    ...
    pub impl ImplInternalPayments of InternalPaymentsTrait {
        ...
        fn _validate_order(
            ...
            assert(order.maker.is_non_zero(), 'INVALID_ZERO_MAKER');
